...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('/home/neosoft/Downloads/numberplaterecognition-main/yolov5', 'custom', source ='local', path='/home/neosoft/Downloads/numberplaterecognition-main/best3.pt') ### The repo is stored locally
...
#calling fuction
main(vid_path="ocr.mp4",vid_out="vid_1.mp4") ### for custom video
